...
| Doc | Status | Purpose |
|---|---|---|
| [active/CRM_MODULE_PRD.md](05-implementation/active/CRM_MODULE_PRD.md) | 🔵 Planning | CRM module: clients/policies/interactions/bank + dashboard + finance math port |
