...
**Active count: 1** — [active/DATA_SPINE_PRD.md](active/DATA_SPINE_PRD.md) (P4 import blocked on user key) · **Completed: 2** — [completed/PROFILER_MODULE_PRD.md](completed/PROFILER_MODULE_PRD.md) · [completed/CRM_MODULE_PRD.md](completed/CRM_MODULE_PRD.md)
