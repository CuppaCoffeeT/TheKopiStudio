...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    // Warm ink scrim (--drawer-overlay) — pure black reads cold and muddy over
    // the cream ground, so every overlay in the app shares this one value.
    className={cn(
      "fixed inset-0 z-50 bg-[var(--drawer-overlay)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
  />
