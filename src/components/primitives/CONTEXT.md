...
**152 `.tsx` files across 8 groups** — counted from the filesystem on 2026-07-27. Reproduce with:

```sh
find src/components/primitives -name '*.tsx' | wc -l          # total
for d in charts dashboard detail form overlays shell ui; do    # per group
